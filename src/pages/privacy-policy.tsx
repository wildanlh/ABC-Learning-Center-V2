...
export default function PrivacyPolicy() {
  return (
    <>
      ...
      <Layout>
        <div className="container mx-auto px-3 pt-28 lg:px-2 md:w-1/2">
          <div className="mb-10 text-justify">
            <h2 className="text-2xl font-bold mb-2">
              Privacy Policy for ABC Corporation
            </h2>
            <p>
              At ABC Learning Center, accessible from edu.abc.com, one of our
              ...
              and recorded by ABC Learning Center and how we use it.
            </p>
            <p>
            ...
            <p>
              ...
              that they shared and/or collect in ABC Learning Center. This
          ...
          <div className="mb-10 text-justify">
            ...
            <p>
              ABC Learning Center follows a standard procedure of using log
          ...
          <div className="mb-10 text-justify">
            ...
            <p>
              Like any other website, ABC Learning Center uses
              &apos;cookies&apos;. These cookies are used to store information
              including visitor&apos;s preferences, and the pages on the website
              that the visitor accessed or visited. The information is used to
              optimize the user&apos;s experience by customizing our web page
          ...
          <div className="mb-10 text-justify">
            ...
            <p>
              ...
              the advertising partners of ABC Learning Center.
            </p>
            <p>
              Third-party ad servers or ad networks uses technologies like
              cookies, JavaScript, or Web Beacons that are used in their
              respective advertisements and links that appear on ABC Learning
              Center, which are sent directly to user&apos;s browser. They
            ...
            <p>
              Note that ABC Learning Center has no access to or control over
          ...
          <div className="mb-10 text-justify">
            ...
            <p>
              ABC Learning Center&apos;s Privacy Policy does not apply to other
          ...
          <div className="mb-10 text-justify">
            ...
            <p>
              ABC Learning Center does not knowingly collect any Personal
